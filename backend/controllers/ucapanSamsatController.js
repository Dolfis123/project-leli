...
const createUcapan = (req, res) => {
  ...
  upload.single("image")(req, res, (err) => {
    ...
    const sqlQuery = "INSERT INTO tb_pesan_samsat (pesan, image) VALUES (?, ?)";
...
const getAllUcapan = (req, res) => {
  ...
  const sqlQuery = "SELECT * FROM tb_pesan_samsat";
...
const deleteUcapan = (req, res) => {
  ...
  const sqlQuery = "DELETE FROM tb_pesan_samsat WHERE id = ?";
...
const updateUcapan = (req, res) => {
  upload.single("image")(req, res, (err) => {
    ...
    const id = req.params.id;
    let sqlQuery = "UPDATE tb_pesan_samsat SET pesan = ?";
...
const getById = (req, res) => {
  const id = req.params.id;
  const sqlQuery = "SELECT * FROM tb_pesan_samsat WHERE id = ?";
  db.query(sqlQuery, [id], (err, result) => {
