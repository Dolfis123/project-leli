...
function PelayananAdmin() {
  ...
  const fetchPelayanan = async () => {
    try {
      const response = await axios.get("http://localhost:8000/pelayanan");
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post("http://localhost:8000/pelayanan", formData, {
        headers: {
  ...
  const handleEditSubmit = async (e) => {
    ...
    try {
      await axios.put(`http://localhost:8000/pelayanan/${editId}`, formData, {
        headers: {
          "Content-Type": "application/json",
        },
      });
